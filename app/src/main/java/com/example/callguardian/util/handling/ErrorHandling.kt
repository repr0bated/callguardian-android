...
import com.example.callguardian.util.exceptions.CallGuardianException
import com.example.callguardian.util.exceptions.ConfigurationException
import com.example.callguardian.util.exceptions.ContactException
...
import com.example.callguardian.util.exceptions.PermissionException
import com.example.callguardian.util.exceptions.SecurityException
import com.example.callguardian.util.exceptions.StorageException
import com.example.callguardian.util.exceptions.ValidationException
...
object ErrorHandling {
    ...
    fun handleApiError(
        ...
        val exception = com.example.callguardian.util.exceptions.ApiException(
