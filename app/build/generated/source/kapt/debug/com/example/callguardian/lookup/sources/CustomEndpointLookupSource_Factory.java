...
public final class CustomEndpointLookupSource_Factory implements Factory<CustomEndpointLookupSource> {
  ...
  public static CustomEndpointLookupSource_Factory create(
      ...
      Provider<NetworkManager> networkManagerProvider, Provider<Moshi> moshiProvider) {
    return new CustomEndpointLookupSource_Factory(preferencesProvider, clientProvider, networkManagerProvider, moshiProvider);
  }

  public static CustomEndpointLookupSource newInstance(LookupPreferences preferences,
      OkHttpClient client, NetworkManager networkManager, Moshi moshi) {
    return new CustomEndpointLookupSource(preferences, client, networkManager, moshi);
  }
}
