...
public abstract class Hilt_ContactSyncDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ContactSyncDialogFragment() {
    super();
  }

  Hilt_ContactSyncDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ContactSyncDialogFragment_GeneratedInjector) this.generatedComponent()).injectContactSyncDialogFragment(UnsafeCasts.<ContactSyncDialogFragment>unsafeCast(this));
    }
  }
